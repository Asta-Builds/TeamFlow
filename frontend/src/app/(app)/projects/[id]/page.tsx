...
export default function ProjectBoardPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      {/* Top Project Bar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm transition-colors">
        <div>
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            <Link href="/projects" className="text-xs text-indigo-600 dark:text-indigo-400 hover:underline font-semibold flex items-center gap-1">
              <ArrowLeft className="h-3 w-3" />
              <span>Projects</span>
            </Link>
            <span className="text-slate-300 dark:text-slate-600">/</span>
            <span className="text-[10px] font-extrabold text-slate-600 dark:text-slate-400 uppercase tracking-widest bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md">
              {project.status}
            </span>
            {project.github_repo && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-sky-50 dark:bg-sky-950/80 border border-sky-200 dark:border-sky-800/60 hover:border-sky-400 dark:hover:border-sky-500 text-[10px] font-bold text-sky-700 dark:text-sky-300 hover:text-sky-900 dark:hover:text-white transition font-mono"
          ...
          <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 max-w-2xl">{project.description || "No description provided."}</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <FolderGit2 className="h-3.5 w-3.5 text-sky-600 dark:text-sky-400" aria-hidden="true" />
          ...
          <button
            ...
            className="rounded-xl border border-emerald-200 dark:border-emerald-700/60 bg-emerald-50 dark:bg-emerald-950/60 px-3.5 py-2 text-xs font-bold text-emerald-800 dark:text-emerald-200 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 transition flex items-center gap-1.5 cursor-pointer shadow-xs focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:outline-none"
            ...
            aria-haspopup="dialog"
          >
            <span className="flex h-2 w-2 rounded-full bg-emerald-500 animate-pulse motion-reduce:animate-none" aria-hidden="true"></span>
            <Radio className="h-3.5 w-3.5 text-emerald-600 dark:text-emerald-400" aria-hidden="true" />
          ...
          <button
            ...
            className="rounded-xl border border-violet-200 dark:border-violet-700/60 bg-violet-50 dark:bg-violet-950/60 px-3.5 py-2 text-xs font-bold text-violet-800 dark:text-violet-200 hover:bg-violet-100 dark:hover:bg-violet-900/60 transition flex items-center gap-1.5 cursor-pointer shadow-xs focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:outline-none"
          ...
          <Link
            ...
            className="rounded-xl border border-indigo-200 dark:border-indigo-700/60 bg-indigo-50 dark:bg-indigo-950/60 px-3.5 py-2 text-xs font-bold text-indigo-800 dark:text-indigo-200 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 transition flex items-center gap-1.5 cursor-pointer shadow-xs focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
            title="Personal execution: Daily planning, focus sessions & time blocks for this project"
            aria-label="Pulse Cockpit"
          >
            <Timer className="h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400" aria-hidden="true" />
          ...
          <button
            ...
            className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800/80 px-3.5 py-2 text-xs font-bold text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition flex items-center gap-1.5 cursor-pointer disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
            title="Ingest architecture documents & codebase chunks into pgvector"
            aria-label="Ingest RAG Knowledge into pgvector"
          >
            <Database className="h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400" aria-hidden="true" />
      ...
      {/* Filters Toolbar */}
      <div className="flex flex-wrap items-center gap-3 bg-white dark:bg-slate-900/90 p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs transition-colors">
        <div className="flex-1 min-w-[200px] relative">
          <Search className="h-3.5 w-3.5 text-slate-400 dark:text-slate-500 absolute left-3 top-1/2 -translate-y-1/2" aria-hidden="true" />
          <input
            type="text"
            ...
            className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 pl-8.5 pr-3 py-1.5 text-xs text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
          />
        </div>
        ...
        <select
          ...
          className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 focus:outline-none focus:border-indigo-500"
        >
        ...
        {(searchQuery || filterAssignee !== "all" || filterPriority !== "all" || filterType !== "all") && (
          <button
            ...
            className="text-xs font-bold text-rose-600 dark:text-rose-400 hover:underline px-2 cursor-pointer"
          >
            Clear Filters
          </button>
        )}
        ...
        {TASK_COLUMNS.map((col) => {
          ...
          return (
            <div
              ...
              className="flex flex-col rounded-2xl bg-slate-100/70 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 p-3.5 min-h-[540px] shadow-sm transition-colors"
            >
              <div className="mb-3.5 flex items-center justify-between px-1">
                <div className="flex items-center gap-2">
                  <span className={`h-2 w-2 rounded-full ${STATUS_DOT[col]}`} />
                  <span className="text-xs font-extrabold text-slate-900 dark:text-white tracking-tight uppercase">
                    {TASK_STATUS_LABELS[col]}
                  </span>
                  <span className="text-[11px] font-black text-slate-600 dark:text-slate-400 bg-white dark:bg-slate-950 px-2 py-0.5 rounded-md border border-slate-200 dark:border-slate-800">
                    {colTasks.length}
                  </span>
                </div>
                <button
                  ...
                  className="h-6 w-6 rounded-lg bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-700 flex items-center justify-center font-bold text-sm shadow-xs transition cursor-pointer"
              ...
              <div className="flex flex-1 flex-col gap-2.5">
                {colTasks.map((t) => {
                  ...
                  return (
                    <div
                      ...
                      className={`cursor-pointer rounded-xl border p-3.5 text-left shadow-sm transition-all duration-150 hover:-translate-y-0.5 hover:border-slate-400 dark:hover:border-slate-600 ${
                        t.qa_rejected
                          ? "border-rose-200 dark:border-rose-800/60 bg-rose-50/70 dark:bg-rose-950/20"
                          : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/90 hover:bg-slate-50 dark:hover:bg-slate-950"
                      }`}
                    >
                      ...
                      <div className="text-xs font-bold text-slate-900 dark:text-white leading-snug line-clamp-2 mb-2">
                        {t.title}
                      </div>

                      {t.qa_rejected && (
                        <div className="mb-2 rounded-lg bg-rose-100 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-800/40 px-2 py-1 text-[10px] text-rose-800 dark:text-rose-300 font-semibold flex items-center gap-1.5">
                      ...
                      <div className="flex items-center justify-between border-t border-slate-100 dark:border-slate-800/80 pt-2 text-[10px] text-slate-500">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="flex items-center gap-1 text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-300 font-bold transition cursor-pointer"
                            title="Plan or Focus this ticket in Pulse"
                          >
                            <Timer className="h-3 w-3 inline text-indigo-500 dark:text-indigo-400" />
                            <span>Pulse</span>
                          </button>
                          {t.pr_url && (
                            <span className="text-indigo-600 dark:text-indigo-400 font-bold flex items-center gap-1" title="GitHub PR Linked">
                        ...
                        {t.assignee_detail ? (
                          <div className="flex items-center gap-1.5">
                            <span className="truncate max-w-[70px] text-slate-700 dark:text-slate-300 font-semibold">
                ...
                {colTasks.length === 0 && (
                  <div className="rounded-xl border border-dashed border-slate-200 dark:border-slate-800 py-10 text-center text-xs text-slate-400 dark:text-slate-600 font-medium">
                    Empty column
                  </div>
                )}
              </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 dark:bg-slate-950/70 backdrop-blur-xs p-4">
          <div className="w-full max-w-lg rounded-2xl bg-white dark:bg-slate-900 p-6 shadow-2xl border border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-150 space-y-4 transition-colors">
            ...
            <form onSubmit={handleCreateTask} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-xs text-slate-900 dark:text-slate-200 focus:border-indigo-500 focus:outline-none"
                />
              </div>
      ...
      {showPmModal && (
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-slate-950/40 dark:bg-slate-950/80 p-4 backdrop-blur-xs">
          <div className="w-full max-w-xl rounded-2xl bg-white dark:bg-slate-900 p-6 shadow-2xl border border-violet-200 dark:border-violet-800/50 space-y-4 transition-colors">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2.5">
                <div className="h-9 w-9 rounded-xl bg-violet-100 dark:bg-violet-950 border border-violet-200 dark:border-violet-700/60 flex items-center justify-center text-violet-700 dark:text-violet-400">
            ...
            <form onSubmit={handlePmGenerateTasks} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-3.5 text-xs text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:border-violet-500 focus:outline-none leading-relaxed"
                />
              </div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {[
                    ...
                    <button
                      ...
                      className="rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-2.5 py-1 text-[11px] font-medium text-slate-700 dark:text-slate-300 hover:border-violet-500 hover:text-violet-700 dark:hover:text-violet-300 transition cursor-pointer"
                    >
                      {tpl}
                    </button>
                  ))}
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-200 dark:border-slate-800">
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => setShowPmModal(false)}
                    className="px-3.5 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
      ...
      {showDevopsModal && (
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-slate-950/40 dark:bg-slate-950/80 p-4 backdrop-blur-xs">
          <div className="w-full max-w-xl rounded-2xl bg-white dark:bg-slate-900 p-6 shadow-2xl border border-sky-200 dark:border-sky-800/50 space-y-4 animate-in fade-in zoom-in-95 duration-150 transition-colors">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2.5">
                <div className="h-9 w-9 rounded-xl bg-sky-100 dark:bg-sky-950 border border-sky-200 dark:border-sky-700/60 flex items-center justify-center text-sky-700 dark:text-sky-400">
            ...
            <form onSubmit={handleDevopsCreateRepo} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-xs text-slate-900 dark:text-slate-200 font-mono focus:border-sky-500 focus:outline-none"
                />
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`rounded-xl border p-3 text-left transition cursor-pointer flex items-start gap-2.5 ${
                      !devopsRepoPrivate
                        ? "border-sky-500 bg-sky-50 dark:bg-sky-950/40 text-slate-900 dark:text-white"
                  ...
                  >
                    <Globe className="h-4 w-4 text-emerald-500 dark:text-emerald-400 shrink-0 mt-0.5" />
                    <div>
                      <div className="text-xs font-bold text-slate-900 dark:text-white">Public</div>
                      <div className="text-[10px] text-slate-500 dark:text-slate-400">Visible to everyone on GitHub</div>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div>
                      <div className="text-xs font-bold text-slate-900 dark:text-white">Private</div>
                      <div className="text-[10px] text-slate-500 dark:text-slate-400">Only authorized members can view</div>
                    </div>
                  </button>
                </div>
              </div>
              ...
              {/* Automated checklist */}
              <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/70 p-3 space-y-1.5 text-xs text-slate-700 dark:text-slate-300">
                <div className="text-[10px] font-extrabold uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-1">
...
function TaskDetailPanel({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-950/40 dark:bg-slate-950/70 backdrop-blur-xs" onClick={onClose}>
      <div
        className="h-full w-full max-w-xl overflow-y-auto bg-white dark:bg-slate-900 p-6 shadow-2xl border-l border-slate-200 dark:border-slate-800 flex flex-col justify-between transition-colors"
      ...
      >
        <div className="space-y-5">
          ...
          <div className="flex items-start justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-4">
            <div>
              ...
              <h2 className="text-lg font-black text-slate-900 dark:text-white leading-tight">{detail.title}</h2>
            </div>
          ...
          <div className="p-4 bg-gradient-to-r from-indigo-50 via-slate-50 to-white dark:from-indigo-950 dark:via-slate-900 dark:to-slate-950 text-slate-900 dark:text-white rounded-2xl shadow-sm border border-indigo-200 dark:border-indigo-800/40 transition-colors">
            ...
            {isStreaming && (
              <div className="mt-3 flex items-center justify-between p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/70 border border-emerald-200 dark:border-emerald-700/60 text-emerald-800 dark:text-emerald-300 text-xs">
                ...
                <button
                  ...
                  className="shrink-0 text-[11px] font-bold text-emerald-700 dark:text-emerald-200 underline hover:text-emerald-900 dark:hover:text-white cursor-pointer ml-2"
                >
                  View Stream
                </button>
              </div>
          ...
          {detail.qa_rejected && (
            <div className="p-3.5 bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-800/50 rounded-xl text-xs text-rose-800 dark:text-rose-300 space-y-1">
          ...
          {detail.status === "qa" && canPerformQa && (
            <div className="p-4 bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800/40 rounded-xl space-y-2">
          ...
          {/* Core Properties */}
          <div className="grid grid-cols-2 gap-4 text-xs bg-slate-50 dark:bg-slate-950/70 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
            <div>
              <span className="text-slate-600 dark:text-slate-400 block font-semibold mb-1">Assignee</span>
              <select
                value={detail.assignee || ""}
                onChange={(e) => updateField({ assignee: e.target.value ? Number(e.target.value) : null })}
                className="w-full rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-2 py-1.5 text-xs text-slate-900 dark:text-white font-semibold focus:outline-none"
              >
                <option value="">Unassigned</option>
                {teamMembers.map((m) => (
                  <option key={m.id} value={m.id}>
            ...
            <div>
              <span className="text-slate-600 dark:text-slate-400 block font-semibold mb-1">Priority</span>
              <select
            ...
            {detail.due_date && (
              <div>
                <span className="text-slate-600 dark:text-slate-400 block font-semibold mb-0.5">Due Date</span>
                <span className="font-bold text-slate-800 dark:text-slate-200 flex items-center gap-1">
                  <Calendar className="h-3 w-3 inline text-slate-500 dark:text-slate-400" /> {detail.due_date}
                </span>
              </div>
            )}
            ...
            {detail.pr_url && (
              <div>
                <span className="text-slate-600 dark:text-slate-400 block font-semibold mb-0.5">Pull Request</span>
                <a
                  href={detail.pr_url}
                  target="_blank"
                  rel="noreferrer"
          ...
          {detail.description && (
            <div>
              ...
              <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-3.5 text-xs text-slate-700 dark:text-slate-300 whitespace-pre-wrap leading-relaxed">
                {detail.description}
              </div>
            </div>
          )}
          ...
          {/* Status Progression */}
          <div>
            <label className="block text-[10px] font-extrabold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">
              Status Progression
            </label>
            <div className="flex flex-wrap gap-1.5">
              {TASK_COLUMNS.map((s) => (
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 pt-4">
            <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 mb-4 overflow-x-auto">
              <button
              ...
              >
                ...
                {detail.contract_compliance_score !== undefined && detail.contract_compliance_score > 0 && (
                  <span className="ml-1 text-[10px] bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800/60 text-emerald-700 dark:text-emerald-300 px-1.5 py-0.5 rounded-full">
              ...
              >
                ...
                {pulsePlanItem && (
                  <span className="ml-1 rounded-full border border-indigo-200 dark:border-indigo-700/60 bg-indigo-50 dark:bg-indigo-950 px-1.5 py-0.5 text-[9px] font-extrabold text-indigo-700 dark:text-indigo-300 uppercase">
                ...
                {latestTrace ? (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2.5">
                      ...
                      <div className="space-y-2 max-h-72 overflow-y-auto pr-1">
                        {latestTrace.steps?.map((step, idx) => (
                          <div
                            key={idx}
                            className="p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 space-y-1.5 text-xs"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-1.5">
                                <Bot className="h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400" />
                                <span className="font-bold text-slate-900 dark:text-white">{step.agent_role}</span>
                              </div>
                            ...
                            {step.pr_url && (
                              <div className="pt-1">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="inline-flex items-center gap-1 text-[11px] font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-800/40 px-2 py-0.5 rounded-md hover:text-indigo-800 dark:hover:text-indigo-300"
                                >
                                  <GitPullRequest className="h-3 w-3" />
                    ...
                    {latestTrace.graph_state?.retrieved_context && latestTrace.graph_state.retrieved_context.length > 0 && (
                      <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-3 space-y-1.5 text-xs">
                        <div className="flex items-center justify-between text-slate-600 dark:text-slate-400 font-bold text-[10px] uppercase tracking-wider">
                        ...
                        <div className="max-h-28 overflow-y-auto space-y-1 text-[11px] text-slate-600 dark:text-slate-400 font-mono bg-white dark:bg-slate-900 p-2 rounded-lg border border-slate-200 dark:border-slate-800">
                          {latestTrace.graph_state.retrieved_context.map((chunk, cIdx) => (
                            <div key={cIdx} className="border-b border-slate-100 dark:border-slate-800 pb-1 last:border-0 last:pb-0">
                              {chunk}
                            </div>
                          ))}
                        </div>
                  ...
                  <div className="p-6 text-center rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 space-y-3">
                    <Bot className="h-8 w-8 text-slate-400 dark:text-slate-600 mx-auto" />
                    <h4 className="text-xs font-bold text-slate-900 dark:text-white">No Multi-Agent Swarm Executed Yet</h4>
              ...
              <div className="space-y-4">
                    ...
                    return (
                      <div
                        ...
                        className={`flex gap-3 text-xs p-3.5 rounded-2xl border transition ${
                          isHandoff
                            ? "bg-white dark:bg-slate-950 border-indigo-200 dark:border-indigo-800/60 shadow-md ring-1 ring-indigo-500/20"
                            : isAi
                            ? "bg-slate-50/80 dark:bg-slate-950/80 border-indigo-100 dark:border-indigo-900/40 shadow-xs ring-1 ring-indigo-500/10"
                        ...
                        <div className="flex-1 space-y-1.5">
                          <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-2 flex-wrap">
                              <span className="font-bold text-slate-900 dark:text-white">{c.author_detail?.name || "System"}</span>
                              <AgentTypeBadge role={c.author_detail?.role} isAi={isAi} />
                              {isHandoff && (
                                <span className="text-[10px] font-extrabold text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-950 border border-indigo-200 dark:border-indigo-700/60 px-2 py-0.5 rounded-md flex items-center gap-1">
                ...
                <div className="pt-2 border-t border-slate-200 dark:border-slate-800 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {[
                      { tag: "@pm", label: "PM (Planner)", color: "hover:border-violet-500 hover:text-violet-600 dark:hover:text-violet-300" },
                      { tag: "@tech_lead", label: "Tech Lead", color: "hover:border-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-300" },
                      { tag: "@backend", label: "Backend", color: "hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-300" },
                      { tag: "@frontend", label: "Frontend", color: "hover:border-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-300" },
                      { tag: "@qa", label: "QA Gate", color: "hover:border-emerald-500 hover:text-emerald-600 dark:hover:text-emerald-300" },
                      { tag: "@devops", label: "DevOps", color: "hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-300" },
                      { tag: "@designer", label: "UI/UX", color: "hover:border-pink-500 hover:text-pink-600 dark:hover:text-pink-300" },
                      { tag: "@seo", label: "SEO", color: "hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-300" },
                      { tag: "@all", label: "All Swarm", color: "hover:border-purple-500 hover:text-purple-600 dark:hover:text-purple-300" },
                    ].map((pill) => (
                      <button
                        key={pill.tag}
                        type="button"
                        ...
                        className={`px-2 py-0.5 rounded-lg text-[10px] font-bold border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400 transition cursor-pointer ${pill.color}`}
                      >
                        {pill.tag}
                      </button>
                    ))}
                  ...
                  <form onSubmit={addComment} className="flex gap-2 pt-1">
                    <input
                      ...
                      className="flex-1 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-xs text-slate-900 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-indigo-500 focus:outline-none"
                    />
                    <button
                      type="submit"
                      disabled={posting}
            ...
            {activeTab === "activity" && (
              <div className="max-h-72 overflow-y-auto space-y-2.5 text-xs pr-1">
                {detail.activities?.map((a) => (
                  <div key={a.id} className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 flex items-start gap-2.5">
                    <Activity className="h-4 w-4 text-slate-400 dark:text-slate-500 mt-0.5" />
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-slate-900 dark:text-white">{a.actor_detail?.name || "System"}</span>
            ...
            {activeTab === "pulse" && (
              <div className="space-y-4">
                <div className="rounded-2xl border border-indigo-200 dark:border-indigo-800/60 bg-gradient-to-br from-indigo-50/60 via-white to-slate-50 dark:from-indigo-950/40 dark:via-slate-900 dark:to-slate-950 p-4 shadow-sm transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    {pulseSession?.status === "active" && (
                      <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 dark:border-emerald-700/60 bg-emerald-50 dark:bg-emerald-950/80 px-2.5 py-0.5 text-[10px] font-bold text-emerald-700 dark:text-emerald-300">
                  ...
                  <div className="mt-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/90 p-4">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="mt-2 flex items-baseline gap-3">
                      <span className="font-mono text-3xl font-black text-slate-900 dark:text-white tabular-nums">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3.5 py-2 text-xs font-bold text-slate-700 dark:text-slate-300 hover:border-indigo-600 hover:text-indigo-600 dark:hover:text-white transition"
                      >
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    {pulsePlanItem ? (
                      <div className="flex items-center justify-between rounded-xl border border-indigo-200 dark:border-indigo-700/60 bg-indigo-50 dark:bg-indigo-950/40 p-3">
                        <div className="flex items-center gap-2">
                          <SquareCheckBig className="h-4 w-4 text-emerald-500 dark:text-emerald-400" />
                          <span className="text-xs font-bold text-slate-900 dark:text-white">
                            Scheduled for today in <span className="capitalize text-indigo-700 dark:text-indigo-300 font-extrabold">{pulsePlanItem.time_block}</span> segment
                          </span>
                        </div>
                        <Link
                          href={detail.project ? `/pulse?project=${detail.project}` : "/pulse"}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        {[
                          ...
                          <button
                            ...
                            className="flex flex-col items-start rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/80 p-2.5 text-left transition hover:border-indigo-500 hover:bg-indigo-50/40 dark:hover:bg-indigo-950/20 disabled:opacity-50 cursor-pointer"
                          >
                            <span className="text-xs font-bold text-slate-900 dark:text-white">
        ...
        {/* QA Rejection Modal */}
        {rejectModal && (
          <div className="fixed inset-0 z-60 flex items-center justify-center bg-slate-950/40 dark:bg-slate-950/70 p-4 backdrop-blur-xs">
            <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-slate-900 p-5 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-3 transition-colors">
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">Specify QA Rejection Reason</h3>
              ...
              <form onSubmit={handleQaReject} className="space-y-3">
                <textarea
                  ...
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-2.5 text-xs text-slate-900 dark:text-slate-200 focus:border-rose-500 focus:outline-none"
                />
...
function SwarmLiveFeedModal({
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-slate-950/40 dark:bg-slate-950/80 p-4 backdrop-blur-xs">
      <div className="w-full max-w-4xl h-[85vh] rounded-2xl bg-white dark:bg-slate-900 shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 p-4 bg-slate-50 dark:bg-slate-950">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-600 dark:text-emerald-400 shadow-xs">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="flex items-center gap-1 bg-emerald-500/10 border border-emerald-500/30 text-emerald-700 dark:text-emerald-300 text-[10px] font-bold px-2 py-0.5 rounded-full">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Projet : <span className="text-slate-800 dark:text-slate-200 font-semibold">{projectName}</span> · Dialogue et passages de relais entre agents
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => fetchFeed()}
              className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition cursor-pointer"
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-xl text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-white transition cursor-pointer"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
        ...
        {/* Filter bar */}
        <div className="flex items-center justify-between gap-3 p-3 bg-slate-100/60 dark:bg-slate-950/60 border-b border-slate-200 dark:border-slate-800 text-xs">
        ...
        {streamError && (
          <div className="border-b border-amber-500/30 bg-amber-500/10 px-4 py-2 text-[11px] text-amber-800 dark:text-amber-300">
        ...
        <div
          ...
          className="flex-1 overflow-y-auto p-4 space-y-3.5 bg-slate-50/50 dark:bg-slate-900/60"
        >
            ...
            return (
              <div
                ...
                className={`p-4 rounded-2xl border transition space-y-2 ${
                  isHandoff
                    ? "bg-indigo-50/70 dark:bg-slate-950 border-indigo-200 dark:border-indigo-800/50 shadow-xs ring-1 ring-indigo-500/20"
                    : isFailed
                    ? "bg-red-50/70 dark:bg-slate-950 border-red-200 dark:border-red-800/50"
                    : isDone
                    ? "bg-emerald-50/70 dark:bg-slate-950 border-emerald-200 dark:border-emerald-800/50"
              ...
              >
                <div className="flex items-center justify-between gap-2 border-b border-slate-100 dark:border-slate-800/60 pb-2">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-bold text-slate-900 dark:text-white">{item.sender_name || "TeamFlow Orchestrator"}</span>
                        {item.recipient_key && (
                          <span className="text-[11px] font-extrabold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950 border border-indigo-200 dark:border-indigo-800/60 px-2 py-0.5 rounded-md flex items-center gap-1">
                            <span>➔</span>
                ...
                <div className="text-xs text-slate-700 dark:text-slate-300 font-normal leading-relaxed pl-1">
                  <GenerativeMessageRenderer
                ...
                <div className="flex flex-wrap items-center gap-2 pl-1 text-[10px]">
                  <span className="rounded-md border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-900 px-2 py-0.5 font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300">
                    {item.event_type}
                  </span>
                  {item.current_work && <span className="text-slate-600 dark:text-slate-400">Now: {item.current_work}</span>}
                </div>
          ...
          {filteredFeed.length === 0 && !loading && (
            <div className="text-center py-16 space-y-2">
              <Bot className="h-8 w-8 text-slate-400 dark:text-slate-600 mx-auto" />
              <p className="text-xs text-slate-600 dark:text-slate-400">Aucun échange pour le moment.</p>
