  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {/* Starter Plan */}
        <div className={`bg-white dark:bg-slate-900/90 border rounded-2xl p-6 flex flex-col justify-between shadow-xs relative ${currentTier === "starter" ? "ring-2 ring-indigo-500 border-indigo-500" : "border-slate-200 dark:border-slate-800"}`}>
          {currentTier === "starter" && (
          ...
          <div>
            <h3 className="font-bold text-base text-slate-900 dark:text-white">Starter</h3>
            <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">For small teams getting started with issue tracking.</p>
            <div className="my-5">
          ...
          <button
            disabled
            className="w-full py-2 bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 rounded-xl text-xs font-semibold cursor-not-allowed"
          >
        ...
        <div className={`bg-white dark:bg-slate-900 border-2 rounded-2xl p-6 flex flex-col justify-between shadow-xl relative ${currentTier === "growth" ? "border-indigo-500 ring-2 ring-indigo-500/50 shadow-indigo-600/20" : "border-slate-200 dark:border-slate-800"}`}>
          <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[10px] font-extrabold uppercase tracking-widest px-3 py-0.5 rounded-full">
            {currentTier === "growth" ? "Active Plan" : "Recommended"}
          </span>
          <div>
            <h3 className="font-bold text-base text-slate-900 dark:text-white">Growth</h3>
            <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">Full swarm power for fast-scaling engineering teams.</p>
            <div className="my-5">
        ...
        {/* Enterprise Plan */}
        <div className={`bg-white dark:bg-slate-900/90 border rounded-2xl p-6 flex flex-col justify-between shadow-xs relative ${currentTier === "enterprise" ? "ring-2 ring-indigo-500 border-indigo-500" : "border-slate-200 dark:border-slate-800"}`}>
          ...
          <div>
            <h3 className="font-bold text-base text-slate-900 dark:text-white">Enterprise</h3>
            <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">Dedicated Clerk SSO and SLA support.</p>
            <div className="my-5">
