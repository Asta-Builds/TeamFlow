...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-indigo-500 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-600 text-xs font-extrabold text-white shadow-md shadow-indigo-600/40">
                TF
              </div>
              <span className="text-base font-extrabold tracking-tight text-white">TeamFlow</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-6 text-xs font-semibold text-zinc-400">
              ...
              <a href="#architecture" className="hover:text-white transition">Architecture & RAG</a>
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <Link
                href="/dashboard"
                className="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-xs font-bold text-white shadow-sm hover:bg-indigo-500 transition"
              >
                <span>Dashboard</span>
                <span>→</span>
              </Link>
              ...
              <>
                <button
                  ...
                  className="hidden sm:inline-flex items-center gap-1.5 rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-1.5 text-xs font-semibold text-zinc-200 hover:bg-zinc-800 transition cursor-pointer"
                ...
                <Link
                  href="/login"
                  className="rounded-lg bg-white px-3.5 py-1.5 text-xs font-bold text-zinc-950 hover:bg-zinc-200 transition"
                >
                  Sign In
                </Link>
              </>
      ...
      {/* 🌟 Hero Section (Dark & Radiant shadcn style) */}
      <section className="relative overflow-hidden pt-16 pb-24 lg:pt-24 lg:pb-32 border-b border-zinc-800/80">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-950/40 px-3.5 py-1 text-xs font-semibold text-indigo-300 shadow-sm backdrop-blur-xs">
            ...
            <span>Announcing TeamFlow 2.0 : LangGraph Multi-Agent Orchestration & RAG</span>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <p className="text-base sm:text-lg text-zinc-400 max-w-2xl mx-auto font-normal leading-relaxed">
              Bridge human engineering with autonomous agent swarms (Tech Lead, Backend, Frontend, QA, DevOps, SEO) across a 5-stage Kanban workflow, grounded by pgvector RAG and traced via Langfuse.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 pt-2">
            ...
            <button
              onClick={loginWithKeycloak}
              className="inline-flex items-center gap-2 rounded-xl border border-zinc-700 bg-zinc-900/90 px-5 py-3 text-xs sm:text-sm font-bold text-zinc-200 hover:bg-zinc-800 transition cursor-pointer"
            >
              <span>🛡️</span>
          ...
          <div className="max-w-4xl mx-auto pt-10 text-left">
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/90 p-5 sm:p-7 shadow-2xl backdrop-blur-xs space-y-6">
              {/* Simulator Header */}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {DEMO_STEPS.map((step, idx) => (
                  ...
                  >
                    <div className="text-xs font-bold text-white truncate">{step.agent.split(" ")[0]} {step.role}</div>
                    <div className="text-[10px] text-zinc-400 mt-0.5 truncate">{step.action}</div>
                  </button>
                ))}
              </div>
              ...
              <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-950 space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <span className="text-base">{DEMO_STEPS[activeStep].agent.split(" ")[0]}</span>
                  ...
                  <div className="flex items-center gap-3 text-[11px] font-mono text-zinc-400">
                    <span>Tokens: <strong className="text-zinc-200">{DEMO_STEPS[activeStep].tokens}</strong></span>
                ...
                {DEMO_STEPS[activeStep].pr_url && (
                  <div className="pt-1">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1 text-[11px] font-bold text-indigo-400 bg-indigo-950/50 border border-indigo-800/40 px-2.5 py-1 rounded-md hover:text-indigo-300"
                    >
                      <span>🐙</span> GitHub PR #324 ↗
                    </a>
                  </div>
                )}
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-zinc-500 pt-1 border-t border-zinc-800/80">
                <div className="flex items-center gap-2 font-mono text-[11px]">
                  <span className="h-2 w-2 rounded-full bg-emerald-500"></span>
                  <span>Langfuse Session: ticket-124-prod-trace</span>
                </div>
                <div className="flex items-center gap-4 text-[11px]">
                  <span>Total Tokens: <strong className="text-zinc-300">1,940</strong></span>
                  <span>Total Latency: <strong className="text-zinc-300">3.2s</strong></span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-6 lg:grid-cols-4 text-center">
            <div className="space-y-1">
              ...
              <div className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Feature Delivery Speed</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl sm:text-4xl font-extrabold text-indigo-400">99.4%</div>
              <div className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">QA Verification Gate Pass</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl sm:text-4xl font-extrabold text-white">pgvector</div>
              <div className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Architecture & Code RAG</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl sm:text-4xl font-extrabold text-emerald-400">100%</div>
              <div className="text-xs font-semibold text-zinc-400 uppercase tracking-wider">Langfuse Session Observability</div>
            </div>
          </div>
        </div>
      </section>

      {/* 🧩 Core Features Grid (#features) */}
      <section id="features" className="py-20 lg:py-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 space-y-3 hover:border-zinc-700 transition">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-950 text-indigo-400 border border-indigo-800/40 text-lg">
              🤖
            </div>
          ...
          {/* Card 2 */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 space-y-3 hover:border-zinc-700 transition">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-950 text-purple-400 border border-purple-800/40 text-lg">
              🔍
            </div>
          ...
          {/* Card 3 */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 space-y-3 hover:border-zinc-700 transition">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-950 text-emerald-400 border border-emerald-800/40 text-lg">
              🧪
            </div>
          ...
          {/* Card 4 */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 space-y-3 hover:border-zinc-700 transition">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-950 text-amber-400 border border-amber-800/40 text-lg">
              📊
            </div>
          ...
          {/* Card 5 */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 space-y-3 hover:border-zinc-700 transition">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-rose-950 text-rose-400 border border-rose-800/40 text-lg">
              🚀
            </div>
          ...
          {/* Card 6 */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 space-y-3 hover:border-zinc-700 transition">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-950 text-cyan-400 border border-cyan-800/40 text-lg">
              🛡️
            </div>
      ...
      {/* 👥 Role-Tailored Portals (#roles) */}
      <section id="roles" className="py-20 border-y border-zinc-800/80 bg-zinc-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {(Object.keys(ROLE_PREVIEWS) as Array<keyof typeof ROLE_PREVIEWS>).map((r) => (
              ...
              >
                {ROLE_PREVIEWS[r].title.split(" ")[0]} {ROLE_PREVIEWS[r].badge}
              </button>
            ))}
          </div>

          {/* Role Detail Showcase Card */}
          <div className="max-w-4xl mx-auto rounded-2xl border border-zinc-800 bg-zinc-900/90 p-6 sm:p-8 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-zinc-800 pb-4">
              <div>
            ...
            <div className="pt-4 flex justify-end">
              <Link
                href="/login"
                className="rounded-xl bg-white px-4 py-2 text-xs font-bold text-zinc-950 hover:bg-zinc-200 transition"
              >
                Experience {ROLE_PREVIEWS[activeRole].title.split(" ")[1]} View →
              </Link>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-20 lg:py-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Starter */}
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-7 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                <h4 className="text-base font-bold text-white">Starter</h4>
                <p className="text-xs text-zinc-400 mt-1">Ideal for small teams exploring virtual management.</p>
              </div>
              ...
              <ul className="space-y-2.5 text-xs text-zinc-300 pt-2">
                ...
                <li className="flex items-center gap-2">✓ Staging Release Pipelines</li>
              </ul>
            </div>
            <Link
              href="/login"
              className="w-full text-center rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-2.5 text-xs font-bold text-white hover:bg-zinc-800 transition block"
            >
          ...
          {/* Growth (Featured) */}
          <div className="relative rounded-2xl border-2 border-indigo-500 bg-zinc-900 p-7 space-y-6 flex flex-col justify-between shadow-2xl shadow-indigo-600/20">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-1">Full swarm power for fast-scaling engineering teams.</p>
              </div>
              <div className="flex items-baseline gap-1">
              ...
              <ul className="space-y-2.5 text-xs text-zinc-300 pt-2">
                <li className="flex items-center gap-2 font-semibold text-white">✓ Unlimited Projects</li>
                <li className="flex items-center gap-2 font-semibold text-white">✓ All 9 Specialist Agent Seats</li>
                <li className="flex items-center gap-2">✓ pgvector Codebase & ADR RAG</li>
                <li className="flex items-center gap-2">✓ Production Deploys & 1-Click Rollback</li>
                <li className="flex items-center gap-2">✓ Langfuse Session Tracing & Cost Logs</li>
              </ul>
            </div>
            <Link
              href="/login"
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-7 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-1">Dedicated security, Keycloak SSO, and custom agents.</p>
              </div>
              <div className="flex items-baseline gap-1">
              ...
              <ul className="space-y-2.5 text-xs text-zinc-300 pt-2">
                ...
                <li className="flex items-center gap-2">✓ Keycloak OpenID Connect Realm</li>
                <li className="flex items-center gap-2">✓ Unlimited Langfuse Trace Retention</li>
                <li className="flex items-center gap-2">✓ Custom LLM Model Adapters</li>
                <li className="flex items-center gap-2">✓ 99.9% Uptime SLA & Priority Support</li>
              </ul>
            </div>
            <Link
              href="/login"
      ...
      <footer className="border-t border-zinc-800/80 bg-zinc-950 py-12 text-xs text-zinc-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-zinc-300">TeamFlow Inc.</span>
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <button onClick={loginWithKeycloak} className="hover:text-zinc-300 transition cursor-pointer">Keycloak SSO</button>
            <a href="http://localhost:8000/api/docs/" target="_blank" rel="noreferrer" className="hover:text-zinc-300 transition">Swagger API</a>
            <a href="https://github.com/Asta-Builds/TeamFlow" target="_blank" rel="noreferrer" className="hover:text-zinc-300 transition">GitHub</a>
