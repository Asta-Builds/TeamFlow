...
export function AgentToolConfirmationModal({
  ...
  return (
    <div className="fixed inset-0 z-70 flex items-center justify-center bg-slate-950/40 dark:bg-slate-950/80 p-4 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="w-full max-w-lg rounded-2xl bg-white dark:bg-slate-900 p-6 shadow-2xl border border-amber-300 dark:border-amber-600/50 space-y-4">
        {/* Header */}
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/70 p-3 text-xs text-slate-700 dark:text-slate-300 leading-relaxed">
            {request.description}
          </div>
          ...
          {request.arguments && Object.keys(request.arguments).length > 0 && (
            <div className="space-y-1">
              ...
              <pre className="p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-950 text-[11px] font-mono text-slate-800 dark:text-slate-300 overflow-x-auto max-h-36">
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-xs text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:border-amber-500 focus:outline-none font-mono"
            />
          </div>
        </div>
