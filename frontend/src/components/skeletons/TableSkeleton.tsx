export function TableSkeleton({ rows = 5 }: { rows?: number }) {
  return (
    <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/40 overflow-hidden animate-pulse">
      {/* Table Header */}
          ...
          <div key={i} className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="h-3 w-28 bg-slate-200/60 dark:bg-slate-800/60 rounded"></div>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="h-5 w-16 bg-slate-200 dark:bg-slate-800 rounded-full"></div>
              <div className="h-4 w-24 bg-slate-200/60 dark:bg-slate-800/60 rounded"></div>
            </div>
          </div>
        ))}
      </div>
