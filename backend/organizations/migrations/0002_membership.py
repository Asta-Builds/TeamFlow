# Generated by Django 5.1.15 on 2026-09-16 20:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ceo', 'Owner (CEO)'), ('admin', 'Admin'), ('member', 'Member')], default='member', max_length=20)),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('user', 'organization'), name='unique_membership_per_workspace')],
            },
        ),
    ]
